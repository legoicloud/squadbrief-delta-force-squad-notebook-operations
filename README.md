...
<div align="center">
  <img src="./public/logo.svg" alt="SquadBrief — Delta Force — Operations" width="64" height="64">
  <h1>SquadBrief — Delta Force — Operations</h1>
</div>

An independent project specification for Delta Force, covering squad role cards, equipment cost notes, post-session review sheets.
...
<img src="./public/screenshots/desktop-main.svg" alt="Delta Force — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Delta Force — compact concept, not a screenshot" width="250">
<br>
...
- **Squad role cards** — planned module; not implemented.
- **Equipment cost notes** — planned module; not implemented.
- **Post-session review sheets** — planned module; not implemented.

The proposed workflow separates squad role cards from equipment cost notes, with post-session review sheets retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Squad role cards**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="SquadBrief — Delta Force — Operations — specification review workflow">
<br>
...
Define the input and expected outcome for module 1. Record the Delta Force version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Equipment cost notes

Define the input and expected outcome for module 2. Record the Delta Force version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Post-session review sheets

Define the input and expected outcome for module 3. Record the Delta Force version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Squad role cards |
